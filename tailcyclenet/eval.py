...
Body of `tailcyclenet eval` (`tailcyclenet/__main__.py`) and of `scripts/eval.py`
(`pixi run python scripts/eval.py pred.npz --data <dataset> --split test`) -- both call this
